...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4FtGN5nSU8LQLigBrHh8"; // 请填写您的AccessKeyId。
        String accessKey = "jROsCA3fIbo3LdsAMBAyMAwKUmMyZe"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-0805"; // 请填写您的 bucketname 。
