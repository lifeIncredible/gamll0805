...
public interface GmallPmsApi {
    ...
    public Resp<CategoryEntity> queryGategoryById(@PathVariable("catId") Long catId);
    ...
    public Resp<SpuInfoDescEntity> queryDescBySpuId(@PathVariable("spuId") Long spuId);
